...
static struct Parameter params[] = {
    ...
    {"PalmTopArea",           PT_INT,    0, 10000, SYNAPTICS_PROP_PALM_TOP,	32,	0},
    {"PalmTopMinZ",           PT_INT,    0, 255,   SYNAPTICS_PROP_PALM_TOP,	32,	1},
    {"ThumbWidth",            PT_INT,    0, 15,    SYNAPTICS_PROP_PALM_TOP,	32,	2},
